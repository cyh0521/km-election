// ================= 數據與設定區 =================
    ...
    const availableElections = [
        ...
        {file: "2024_總統副總統選舉.csv",year: "2024",type: "總統副總統",uiName: "2024年 總統副總統選舉",summaryData: null},
        {file: "2020_總統副總統選舉.csv",year: "2020",type: "總統副總統",uiName: "2020年 總統副總統選舉",summaryData: null},
        {file: "2016_總統副總統選舉.csv",year: "2016",type: "總統副總統",uiName: "2016年 總統副總統選舉",summaryData: null},
        {file: "2012_總統副總統選舉.csv",year: "2012",type: "總統副總統",uiName: "2012年 總統副總統選舉",summaryData: null},
        {file: "2008_總統副總統選舉.csv",year: "2008",type: "總統副總統",uiName: "2008年 總統副總統選舉",summaryData: null},
        {file: "2004_總統副總統選舉.csv",year: "2004",type: "總統副總統",uiName: "2004年 總統副總統選舉",summaryData: null},
        {file: "2000_總統副總統選舉.csv",year: "2000",type: "總統副總統",uiName: "2000年 總統副總統選舉",summaryData: null},
        {file: "1996_總統副總統選舉.csv",year: "1996",type: "總統副總統",uiName: "1996年 總統副總統選舉",summaryData: null},

        {file: "2024_金門縣立委選舉.csv",year: "2024",type: "區域立委",uiName: "2024年 金門縣立委選舉",summaryData: null},
        {file: "2020_金門縣立委選舉.csv",year: "2020",type: "區域立委",uiName: "2020年 金門縣立委選舉",summaryData: null},
        {file: "2019_金門縣立委補選.csv",year: "2019",type: "區域立委",uiName: "2019年 金門縣立委缺額補選",summaryData: null},
        {file: "2016_金門縣立委選舉.csv",year: "2016",type: "區域立委",uiName: "2016年 金門縣立委選舉",summaryData: null},
        {file: "2012_金門縣立委選舉.csv",year: "2012",type: "區域立委",uiName: "2012年 金門縣立委選舉",summaryData: null},
        {file: "2008_金門縣立委選舉.csv",year: "2008",type: "區域立委",uiName: "2008年 金門縣立委選舉",summaryData: null},
        {file: "2004_金門縣立委選舉.csv",year: "2004",type: "區域立委",uiName: "2004年 金門縣立委選舉",summaryData: null},
        {file: "2001_金門縣立委選舉.csv",year: "2001",type: "區域立委",uiName: "2001年 金門縣立委選舉",summaryData: null},
        {file: "1998_金門縣立委選舉.csv",year: "1998",type: "區域立委",uiName: "1998年 金門縣立委選舉",summaryData: null},
        {file: "1995_金門縣立委選舉.csv",year: "1995",type: "區域立委",uiName: "1995年 金門縣立委選舉",summaryData: null},
        {file: "1992_金門縣立委選舉.csv",year: "1992",type: "區域立委",uiName: "1992年 金門縣立委選舉",summaryData: null},
        {file: "1989_金門縣增額立委選舉.csv",year: "1989",type: "區域立委",uiName: "1989年 金門縣增額立委選舉",summaryData: null},

        {file: "2024_不分區立委選舉.csv",year: "2024",type: "不分區立委",uiName: "2024年 不分區立委選舉",summaryData: null},
        {file: "2020_不分區立委選舉.csv",year: "2020",type: "不分區立委",uiName: "2020年 不分區立委選舉",summaryData: null},
        {file: "2016_不分區立委選舉.csv",year: "2016",type: "不分區立委",uiName: "2016年 不分區立委選舉",summaryData: null},
        {file: "2012_不分區立委選舉.csv",year: "2012",type: "不分區立委",uiName: "2012年 不分區立委選舉",summaryData: null},
        {file: "2008_不分區立委選舉.csv",year: "2008",type: "不分區立委",uiName: "2008年 不分區立委選舉",summaryData: null},

        {file: "2005_任務型國代選舉.csv",year: "2005",type: "國大代表",uiName: "2005年 任務型國代選舉",summaryData: null},
        {file: "1996_金門縣國代選舉.csv",year: "1996",type: "國大代表",uiName: "1996年 金門縣國代選舉",summaryData: null},
        {file: "1991_金門縣國代選舉.csv",year: "1991",type: "國大代表",uiName: "1991年 金門縣國代選舉",summaryData: null},

        {file: "2022_金門縣長選舉.csv",year: "2022",type: "縣長",uiName: "2022年 金門縣縣長選舉",summaryData: null},
        {file: "2018_金門縣長選舉.csv",year: "2018",type: "縣長",uiName: "2018年 金門縣縣長選舉",summaryData: null},
	{file: "2014_金門縣長選舉.csv",year: "2014",type: "縣長",uiName: "2014年 金門縣縣長選舉",summaryData: null},
        {file: "2009_金門縣長選舉.csv",year: "2009",type: "縣長",uiName: "2009年 金門縣縣長選舉",summaryData: null},
        {file: "2005_金門縣長選舉.csv",year: "2005",type: "縣長",uiName: "2005年 金門縣縣長選舉",summaryData: null},
        {file: "2001_金門縣長選舉.csv",year: "2001",type: "縣長",uiName: "2001年 金門縣縣長選舉",summaryData: null},
        {file: "1997_金門縣長選舉.csv",year: "1997",type: "縣長",uiName: "1997年 金門縣縣長選舉",summaryData: null},
        {file: "1993_金門縣長選舉.csv",year: "1993",type: "縣長",uiName: "1993年 金門縣縣長選舉",summaryData: null},

        {file: "2022_縣議員選舉第3選區.csv",year: "2022",type: "縣議員",uiName: "2022年 縣議員選舉第3選區",summaryData: null},
        {file: "2022_縣議員選舉第2選區.csv",year: "2022",type: "縣議員",uiName: "2022年 縣議員選舉第2選區",summaryData: null},
        {file: "2022_縣議員選舉第1選區.csv",year: "2022",type: "縣議員",uiName: "2022年 縣議員選舉第1選區",summaryData: null},
        {file: "2018_縣議員選舉第3選區.csv",year: "2018",type: "縣議員",uiName: "2018年 縣議員選舉第3選區",summaryData: null},
        {file: "2018_縣議員選舉第2選區.csv",year: "2018",type: "縣議員",uiName: "2018年 縣議員選舉第2選區",summaryData: null},
        {file: "2018_縣議員選舉第1選區.csv",year: "2018",type: "縣議員",uiName: "2018年 縣議員選舉第1選區",summaryData: null},
        {file: "2014_縣議員選舉第3選區.csv",year: "2014",type: "縣議員",uiName: "2014年 縣議員選舉第3選區",summaryData: null},
        {file: "2014_縣議員選舉第2選區.csv",year: "2014",type: "縣議員",uiName: "2014年 縣議員選舉第2選區",summaryData: null},
        {file: "2014_縣議員選舉第1選區.csv",year: "2014",type: "縣議員",uiName: "2014年 縣議員選舉第1選區",summaryData: null},
        {file: "2009_縣議員選舉第2選區.csv",year: "2009",type: "縣議員",uiName: "2009年 縣議員選舉第2選區",summaryData: null},
        {file: "2009_縣議員選舉第1選區.csv",year: "2009",type: "縣議員",uiName: "2009年 縣議員選舉第1選區",summaryData: null},
        {file: "2005_縣議員選舉.csv",year: "2005",type: "縣議員",uiName: "2005年 縣議員選舉",summaryData: null},
        {file: "2002_縣議員選舉.csv",year: "2002",type: "縣議員",uiName: "2002年 縣議員選舉",summaryData: null},
        {file: "1998_縣議員選舉.csv",year: "1998",type: "縣議員",uiName: "1998年 縣議員選舉",summaryData: null},

        {file: "2025_全國性公投第21案.csv", year: "2025", type: "全國性公民投票", uiName: "2025年 全國性公投第21案（核三延役）",summaryData: null},
        {file: "2006_地方性公投第01案.csv",year: "2006",type: "地方性公民投票",uiName: "2006年 地方性公投第1案（博弈公投）",summaryData: null}

    ];
    
    function isElectionWithoutTowns(electionName) {
        const noTownsElections = [
            "1992年 金門縣立委選舉","1991年 金門縣國代選舉","1989年 金門縣增額立委選舉"
        ];
    ...
    function isPartyListElection(electionName) {
        const partyListElections = [
            ...
            // 簡易判斷：若名稱包含「不分區」、「任務型」或「政黨票」，也視為政黨票
            if (electionName && (electionName.includes("不分區") || electionName.includes("任務型") || electionName.includes("公投") || electionName.includes("政黨票"))) {
            return true;
            }
    ...
    function extractCountySummary(text) {
        ...
        headerRowIndices.forEach(colIndex => {
           ...
           const isWomenQuota = name.includes('*!');
            const isIncumbent = name.includes('#');
            const isWinner = name.includes('*') || isWomenQuota;
            name = name.replace('*!', '').replace('*', '').replace('#', '').trim();party = party === '無' ? '無黨籍' : party;
        ...
        for (let i = 3; i < rows.length; i++) {
           ...
           candInfo.forEach(c => {
                const votes = parseNum(row[c.colIndex]);
                if (!candidates[c.name]) candidates[c.name] = { number: c.number, party: c.party, votes: 0, isWinner: c.isWinner, isWomenQuota: c.isWomenQuota, isIncumbent: c.isIncumbent };    candidates[c.name].votes += votes;
            });
        }
    ...
    window.sortTableInCard = function(cardId, key) {
        ...
        // ***【修正步驟 3】修改這裡：透過 uniqueId 來反查選舉物件 ***
        // 從 cardId (如 "summary-elec-1") 還原出 uniqueId ("elec-1")
    ...
    /**
     * 生成表格內容 HTML (帶有動畫屬性)
     * *** 修改：移除顏色判斷，直接使用 c.party (假設 CSV 資料已統一) ***
     */
    function generateTableBodyHTML(candidates, validVotes, animate, currentElectionYear, isPartyList) {
        return candidates.map(c => {
           ...
           // 若為政黨票，取消點擊事件，並取消連結樣式 (政黨不應該有 modal)
    ...
    /**
     * 更新表格內容 (用於排序/更新時)
     * *** 修改：接收 currentElectionYear 與 isPartyList ***
     */
    ...
    function generateSummaryCardHTML(election) {
        ...
        // ***【修正步驟 2】修改這裡：使用 uniqueId 來產生卡片 ID ***
    ...
    window.renderMainMenu = function(pushState = true) { 
        ...
        html += `<div class="main-section">
            <div class="menu-section-title">依選舉類別瀏覽</div>
    ...
    window.renderReferendumSubMenu = function(pushState = true) {
        ...
        appState.currentLevel = 'referendumMenu'; // 設定一個新的層級狀態
    ...
    window.renderLegislatorSubMenu = function(pushState = true) {
        ...
        appState.currentLevel = 'legislatorMenu'; // 設定一個新的層級狀態
    ...
    window.renderCounty = function(shouldScroll = true, pushState = true) {
        ...
        // 如果只是切換排序(shouldScroll=false)，不執行捲動邏輯
        if (!shouldScroll) {
        ...
        let html = `<div class="main-section">
            ...
            <div class="top-summary-grid">
                ...
                ${generateCardHTML('county-main', '全縣開票結果', candidates, metadata, false, false, true, false, null, true, currentYear)} </div>
        </div>`;
    ...
    // === 新增：立委選單層級 ===
        ...
        // === 修改：原本的 county 邏輯 (判斷公投與立委回上一頁的路徑) ===
    ...
    function generateSummaryPanelHTML(candidates, metadata, title) {
        ...
        // 1. 處理副標題 (選舉名稱)：移出列表，獨立製作成有顏色的副標
        let subtitleHtml = '';
        if (electionNameFromCSV) {
            // style 設定：使用主色調(var(--primary))、加粗、靠左、下方留白
        ...
        // 2. 處理列表中的額外欄位 (只保留投票日期在列表內，如果有的話)
        let extraRows = '';
    ...
    function generateCardHTML(id, title, candidates, metadata, isClickable, onClickAction, isCompact = false, isSummary = false, localSortConfig = null, triggerAnimation = false, currentElectionYear) {
        ...
        // *** 判斷是否為政黨票 ***
        // 1. 先看 Card Title (適用於首頁列表、分類列表)
        let isPartyList = isPartyListElection(title);
        
        // 2. 如果 Card Title 是 "全縣開票結果" 或 "金城鎮" 等，則檢查全域 appState.electionName
           ...
           let headerTextHtml = title;
            ...
            if (sortKey === 'party') {
                ...
                finalClassName = `${className} col-party`;
                 ...
                 headerTextHtml = `政黨`; // 如果是政黨票，將「候選人」改為「政黨」
            }

            // 如果是政黨票，且要渲染「推薦政黨」欄位，則隱藏該欄位
